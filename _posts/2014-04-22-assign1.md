...
Weight parameter(a,b,p) is not easy to choose: It is said that  
setting like a barely greater than zero, b in range [0.5,2] and p in range [0,1] is mostly used.
However, I find that b cannot be larger than 0.3 in my case. It is probably because my image is small and key points
